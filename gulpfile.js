...
gulp.task('default', function(callback) {
	runSequence(
		['build-clean'],
		['move-html', 'move-css', 'move-img', 'move-audio', 'move-lib', 'build-scripts'],
		callback
	);
});
...
gulp.task('production-build', function(callback) {
	runSequence(
		['build-clean'],
		['move-html', 'move-css', 'move-img', 'move-audio', 'move-lib', 'build-scripts-production'],
		callback
	);
});
...
gulp.task('move-lib', function() {
	gulp.src(['./src/scripts/howler.min.js'])
